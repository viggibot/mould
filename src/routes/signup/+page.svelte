	...
	async function submit(e) {
		...
		try {
			...
			if (!res.ok || !data || data.status === 'error')
				throw new Error((data && data.message) || 'Could not create your account.');
		...
		<div class="card">
			...
			<form class="af-form" onsubmit={submit}>
				...
				<div class="af-field">
					...
					<div class="af-inwrap">
						<input class="af-input" id="name" type="text" autocomplete="name" placeholder="Your name" bind:value={name} />
					</div>
				</div>
				...
				<div class="af-field">
					...
					<div class="af-inwrap">
						<input class="af-input" id="password" type={show ? 'text' : 'password'} autocomplete="new-password" placeholder="At least 8 characters" bind:value={password} />
				...
				<label class="af-check">
					...
					<span class="af-note">I agree to the <a class="af-link" href="#">Terms</a> and <a class="af-link" href="#">Privacy Policy</a>.</span>
				</label>
